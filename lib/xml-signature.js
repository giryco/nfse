    ...
    addSignatureToXml(xml, certificate, tagBeforeSignature, signatureId = null, isEmptyUri = null, isDifferentSignature = false) {
        return new Promise((resolve, reject) => {
            try {
                ...
                const xPath = "//*[name(.)='" + tagBeforeSignature + "']"
                if (isDifferentSignature) {
                    sig.addReference(xPath, ["http://www.w3.org/2000/09/xmldsig#enveloped-signature"], null, null, null, null, isEmptyUri);
                    sig.canonicalizationAlgorithm = 'http://www.w3.org/TR/2001/REC-xml-c14n-20010315';
                } else {
                    sig.addReference(xPath, ["http://www.w3.org/2000/09/xmldsig#enveloped-signature", 'http://www.w3.org/2001/10/xml-exc-c14n#'], null, null, null, null, isEmptyUri);
